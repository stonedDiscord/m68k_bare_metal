...
RUN apt update && apt -y install binutils build-essential m4 make libmpc3 libmpc-dev libmpfr6 libmpfr-dev git wget libgmp10 libgmp-dev python-is-python3 srecord xxd zip
